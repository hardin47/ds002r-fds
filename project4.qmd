...
1) Duplicate Figure 1 from <a href = "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7093226/" target = "_blank">Voss (2020)</a>.  You will need to query the WAI Database to build a dataset which you can pipe into `ggplot()` to recreate Figure 1 *as closely as possible* (might not be possible to reproduce exactly).
