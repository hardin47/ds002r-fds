...
schedule <- tribble(
  ...
  '{{< fa book-open >}} <a href="https://r4ds.hadley.nz/regexps.html" target = "_blank"> R4DS Regular expressions</a> <br> {{< fa book-open >}} <a href="https://st47s.com/DS002R/Notes/09-reg-expr.html" target = "_blank">Regular expressions</a> <br> {{< fa desktop >}} <a href="https://ds002r-fds.netlify.app/slides/2025-02-24-regex.html" target = "_blank">Regular expressions</a> <br> {{< fa pencil >}} <a href="https://ds002r-fds.netlify.app/handout/ws9_ds2_s25_regex1.pdf" target = "_blank">WS 9 - Regular Expressions 1</a> <br> {{< fa pencil >}} <a href="https://ds002r-fds.netlify.app/handout/ws10_ds2_s25_regex2.pdf" target = "_blank">WS 10 - Regular Expressions 2</a>',
