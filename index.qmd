...
schedule <- tribble(
 ...
 '{{< fa book-open >}} <a href="https://r4ds.hadley.nz/databases.html" target = "_blank">R4DS Databases</a> <br> {{< fa book-open >}} <a href="https://mdsr-book.github.io/mdsr3e/15-sqlI.html" target = "_blank">MDSR Database querying</a> <br> {{< fa book-open >}} <a href="https://st47s.com/DS002R/Notes/04-sql-in-R.html" target = "_blank">SQL</a> <br> {{< fa desktop >}} <a href="https://ds002r-fds.netlify.app/slides/2024-11-11-db.html" target = "_blank">SQL DBMS</a> <br> {{< fa pencil >}} <a href="https://ds002r-fds.netlify.app/handout/ws17_ds2_f24_sql1.pdf" target = "_blank">WS 17 - sql 1</a>',
