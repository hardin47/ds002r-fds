...
"3.17.25", 'Spring Break', ' ', ' ', ' ',
 ...
 '{{< fa book-open >}} <a href="https://st47s.com/DS002R/Notes/13-permutation-tests.html" target = "_blank">Permutation tests</a> <br> {{< fa desktop >}} <a href="https://ds002r-fds.netlify.app/slides/2025-03-26-perm.html" target = "_blank">Permutation tests</a> <br> {{< fa pencil >}} <a href="https://ds002r-fds.netlify.app/handout/ws16_ds2_s25_permtest.pdf" target = "_blank">WS 16 - permutation test</a> <br> {{< fa pencil >}} <a href="https://ds002r-fds.netlify.app/handout/ws17_ds2_s25_ethics.pdf" target = "_blank">WS 17 - ethics</a>',
