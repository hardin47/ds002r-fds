...
2. The second thing to do is to prepare a ~5 min presentation on some aspect of your project.  It can be about any aspect of the project (or all aspects of the project), and your presentation should be as if to a client about the work.  You'll create the presentation in Quarto (formatted as revealjs) rendered to html.  The presentation will be either on Friday December 5th during reading days (9am-noon) or during our regularly scheduled final time, Wednesday December 10th 9am-noon (your choice).

3. Write up a document detailing the changes you have made to your website.

## Timeline

Project 6 must be submitted on Canvas (not Gradescope) by **11:59 PM on Wednesday, December 10, 2025**.  To Canvas submit two things:  1. the URL of your overall website, 2. a document detailing the changes you have made.

Additionally, you will give a ~5 min presentation to the class on some aspect(s) of your project.  You can describe one of the projects, the creation of the website, the entire project overall, or any other aspect of the project.  (You will present either on the Friday December 5th during reading days (9am-noon) or during our regularly scheduled final time, Wednesday December 10th 9am-noon.)
...
IMPORTANT: you want your website to represent **your** knowledge.  If all the code on the website is from ChatGPT, you should go back and re-write the code so that it actually represents what you have learned in the class.
  ...
  * clean up the entire website
     ...
     - alt text on all plots (make your website accessible! <a href = "https://www.apreshill.com/blog/2022-04-we-dont-talk-about-quarto/#what-youll-like" target = "_blank">how to add alt text</a>. you must have alt text on all your plots to get full credit on this project.) Feel free to use (and then check!!!) the <a href = "https://numbats.github.io/autoAlt/index.html" target = _blank">`autoAlt` package</a> in R which automatically generates alt text.
  ...
  * create a corresponding document (text, Word, Google doc, pdf, etc.) describing (in enough detail to receive credit!) all of the changes you've made from the original set of projects. The document does not need to be long or formatted in any particular way. It does need to communicate what you have done.
