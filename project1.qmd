...
Then, in the Menu bar, you should have a selection called "Data Viz" with two sub-selections, each being a <a href = "" target = "_blank">TidyTuesday</a> analysis.
...
The TidyTuesday analysis can be quite minimal. One scatterplot per analysis is fine, and you don't need to annotate or make it beautiful (of course, you might **want** to make it beautiful...).
