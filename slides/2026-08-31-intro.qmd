...
::: {.callout-important}
Read about the <a href = "https://simplystatistics.org/posts/2019-01-09-how-data-scientists-think-a-mini-case-study/" target = "_blank">data science study</a> originally hosted on the podcast Not So Standard Deviations - Compromised Shoe Situation.
:::
...
![](../images/tour-quarto.png){fig-alt="Positron IDE with a Quarto document, source code on the left and output on the right. Annotated to show the YAML, a link, a header, and a code chunk." fig-align="center"}
