...
::: {.callout-important}
Listen to the <a href = "https://drive.google.com/file/d/1mdaX6Q5DtYMKAujw5ot1LMcP0JLjC2fp/view?usp=sharing" target = "_blank">data science study</a> originally hosted on the podcast Not So Standard Deviations - Compromised Shoe Situation.
:::
...
* no computers in class (tablets fine)
* put your phone into your backpack
* good communication
* TidyTuesday
...
::: {.column width="50%"}
* office hours
* mentor sessions (Mon & Tues 8-10pm)
* anonymous feedback
...
![](../images/positron-logo.png){fig-alt="Positron logo"}
...
[![](../images/r_vs_positron.png){fig-alt="On the left: a car engine. On the right: a car dashboard. The engine is labelled R. The dashboard is labelled Positron." fig-align="center" width="1001"}](https://moderndive.com/1-getting-started.html)
...
-   As of August 30, 2026, there are 24,810 R packages available on **CRAN** (the Comprehensive R Archive Network)<sup>2</sup>
...
![](../images/tour-quarto-positron.png){fig-alt="Positron IDE with a Quarto document, source code on the left and output on the right. Annotated to show the YAML, a link, a header, and a code chunk." fig-align="center"}
...
-   Every assignment is a Quarto document.
