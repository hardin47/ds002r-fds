---
title: Joining and Pivoting
author: "Jo Hardin"
subtitle: "September 21 + 23, 2026"
format:
  revealjs:
    incremental: false
    scrollable: true
...
knitr::include_graphics(c(
  "../images/pivotlonger.png",
  "../images/pivotwider.png"
))
```
...
litF <- litF |>
  ...
  pivot_longer(cols = -country, names_to = "year", values_to = "litRateF") |>
...
paralympic_1500 |>
  ...
  select(year, type, time_min) |>
  pivot_wider(names_from = type, values_from = time_min) |>
  ggplot(aes(x = Olympic, y = T13)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0) +
  labs(title = "Olympic 1500m times")
```
...
## Practice joining `litF` and `GDP` from Gapminder
