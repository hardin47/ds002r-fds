...
We cannot claim that there is a difference in average math scores in the population (p-value = 0.086).

We cannot claim that there is a difference in median math scores int he population (p-value = 0.27).
