...
Consider a racial prediction algorithm including published software for the classifer under an open-source license as the R package **wru** [@imai2016]. (Trained using <a href = "https://www.census.gov/topics/population/genealogy/data.html" target = "_blank">US Census Surname Data</a>.)
