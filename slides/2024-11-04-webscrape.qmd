...
img1 <- image_read("../images/GAcovid.jpg")
img2 <- image_read("../images/GAcovid2.jpg")
img3 <- image_read("../images/GAheatmap1.jpeg")
img4 <- image_read("../images/GAheatmap2.jpeg")
...
image_write(img1_with_border, "../images/img1_with_border.png")
image_write(img2_with_border, "../images/img2_with_border.png")
image_write(img3_with_border, "../images/img3_with_border.png")
image_write(img4_with_border, "../images/img4_with_border.png")
```
...
```{r fig.cap = "July 2, 2020, Georgia Department of Health, COVID-19 cases per 100K https://dph.georgia.gov/covid-19-daily-status-report", out.width='42%', fig.align='center', echo=FALSE, fig.show = 'hold'}
knitr::include_graphics("../images/img3_with_border.png")
```
:::

::: {.column width=50%}
```{r fig.cap = "July 17, 2020, Georgia Department of Health, COVID-19 cases per 100K https://dph.georgia.gov/covid-19-daily-status-report", out.width='42%', fig.align='center', echo=FALSE, fig.show = 'hold'}
knitr::include_graphics("../images/img4_with_border.png")
```
:::
