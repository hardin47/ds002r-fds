...
Our approach to web scraping relies on the Chrome browser and an extenstion called a Selector Gadget.  Download them here:
...
-   Use the **rvest** R package to first read the whole page (into R) and then parse the object you've read in to the elements you're interested in
