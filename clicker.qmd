...
(@) `grep("q[^u]", very.large.word.list)` would not match which of the following?[^127]
    (a) Iraqi
    (b) Iraqian
    (c) Iraq
...
(@) Which of the following regex would match to both "grey" and "gray"?[^128]
    (a) "gr[ae]y"
    (b) "gr(a|e)y"
    (c) "gray | grey"
    (d) "gr[a|e]y"
...
(@) What will the result be for the following code?[^129]  
    (a) 10
    (b) 1
    (c) 0
    (d) NA
...
(@) What will the result be for the following code?[^130]  
    (a) 10
    (b) 1
    (c) 0
    (d) NA
...
(@) What will the result be for the following code?[^131]
    (a) .
...
(@) What will the result be for the following code?[^132]
    (a) .
    (b) Episode 2: The pie whisperer. (4 August 2015)
    (c) Episode
    (d) E
...
(@) What will the result be for the following code?[^133]
    (a) .
    (b) Episode 2: The pie whisperer. (4 August 2015)
    (c) Episode
    (d) E
...
(@) How can I pull out just the numerical information in \$47?[^134]
    (a) "(?<=\\$)\\d"
    (b) "(?<=\\$)\\d+"
    (c) "\\d(?=\\$)"
    (d) "\\d+(?=\\$)"
...
(@) You want to know all the types of pies in the text strings.  They are written as, for example "apple pie".[^135]
    (a) "\\w+(?!pie)"
    (b) "\\w+(?! pie)"
    (c) "\\w+(?=pie)"
    (d) "\\w+(?= pie)"
...
(@) We say that lookarounds are "zero-lenghth assertions".  What does that mean?[^136]
