...
11. The goal of making a figure is...[^11]
     (a)  To draw attention to your work.
     (b) To facilitate comparisons.
     (c) To provide as much information as possible.

[^11]: Yes! All the responses are reasons to make a figure.

---

12. A good reason to make a particular choice of a graph is:[^12]
...
[^12]: c. Because that graphic displays the message you want as optimally as possible.

---

13. Why are the points orange?[^13]
...
[^13]: c. color must be specified **outside** the `aes()` function

---

14. Why are the dots blue and the lines colored?[^14]
...
[^14]: a. dot color is specified as "navy", line color is specified as `wday`.

---

15. Setting vs. Mapping.  If I want information to be passed to all data points (not variable):[^15]
     (a) map the information inside the `aes()` function.
     (b) set the information outside the `aes()` function
     
[^15]: b. set the information outside the `aes()` function

---

16. The Snow figure was most successful at:[^16]
     (a) making the data stand out
     (b) facilitating comparison
     (c) putting the work in context
     (d) simplifying the story

[^16]: answers may vary. I'd say c. putting the work in context.  Others might say b. facilitating comparison or d. simplifying the story.  However, I don't think a correct answer is a. making the data stand out.

---

17. The Challenger figure(s) was(were) least successful at:[^17]
    (a) making the data stand out
    (b) facilitating comparison
    (c) putting the work in context
    (d) simplifying the story

[^17]: a. making the data stand out

---

18. The biggest difference between Snow and the Challenger was:[^18]
...
[^18]: c. One showed the relevant **comparison** better.

---
 
19. Caffeine and Calories.  What was the biggest concern over the average value axes?[^19]
...
[^19]: a. It isn’t at the origin. in combination with d. There wasn’t a label explaining why the axes were where they were.  The story associated with the average value axes is not clear to the reader.
