...
Each assignment will be provided as a link to GitHub. Click the link.  (The link will come to you via an email. If you lose the email, or the email goes to your spam folder, let me know or ask a friend for the link.)
...
The homework assignments will be individual assignments.
Some other assignments might be a paired assignment.
...
<aside>
&#9888; You may need to add a description of the assignment (for example “HW 2”) to team name. This is because GitHub Classroom does seem to make it easy for some people to work in the same group as a previous assignment while other people form new groups.
</aside>
