...
author:
  - name: Jo Hardin 
    url: https://ds002r-fds.netlify.app/
...
Each assignment will be provided within a separate GitHub repository. You will get to the specific repository via the <a href = "https://github.com/orgs/ST47S-FODS-Fall2025/repositories" target = "_blank">course organization</a>. 
